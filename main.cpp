...
int main()
{
    ...
    cout<<"Which algorithm you want to use?"<<endl<<"1-Collaborative Filtering: Predicts the rate of movie A for user B (15s -1 min)."<<endl<<"2-Content Based: Predicts top 10 recommended movies for user A (20 min)."<<endl;
    cin>>a;
